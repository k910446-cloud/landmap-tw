...
(function (g) {
  ...
  var OVERLAYS = [
    ...
    // 屬於哪一個都市計畫區 —— 圖磚只能用眼睛看個大概。
    {
      ...
      note: '全國 22 縣市、421 個都市計畫區的外框，滑過去會顯示計畫區名稱'
        + '（例如「新豐(山崎地區)都市計畫」）。框內走都市計畫法與各縣市施行細則，'
        + '框外走區域計畫法與非都市土地使用管制規則。'
        + '臺北市、基隆市、新竹市、金門縣在上游清單裡只有一個涵蓋全市的計畫區，'
        + '所以那幾個縣市顯示的是全市計畫名稱，不會細到子計畫。'
        + '本圖資僅供參考，實際範圍以各該都市計畫公告發布實施之書圖為準。'
    },
